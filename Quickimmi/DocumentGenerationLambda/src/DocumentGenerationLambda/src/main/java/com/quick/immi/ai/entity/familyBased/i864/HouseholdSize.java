...
public class HouseholdSize {
  ...
  // 232 - If you have sponsored any other persons on Form I-864 or I-864EZ who are now lawful permanent residents
  private String sponsoredOtherPersons;

  // 233 - OPTIONAL: If you have siblings, parents, or adult children with the same principal residence
