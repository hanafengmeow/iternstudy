...
class I829FormFillerTest {

    private I829FormFiller formFiller;
    ...
    void setUp() throws Exception {
        ...
        try (Reader reader = new InputStreamReader(
                getClass().getClassLoader().getResourceAsStream("i829-test.json"), StandardCharsets.UTF_8)) {
            i829Table = gson.fromJson(reader, I829Table.class);
        }
        ...
        formFiller = new I829FormFiller(i829Table, task);
        formFiller.init();
    } 
