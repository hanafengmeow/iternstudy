...
class I589FormFillerTest {

    private I589FormFiller formFiller;
    ...
    void setUp() throws Exception {
        ...
        try (Reader reader = new InputStreamReader(
                getClass().getClassLoader().getResourceAsStream("i589-test.json"), StandardCharsets.UTF_8)) {
            i589Table = gson.fromJson(reader, I589Table.class);
        }
        ...
        formFiller = new I589FormFiller(i589Table, task);
        formFiller.init();
    }
